...
const BannerImage = () => {
    return (
        <svg width="680" height="auto" viewBox="0 0 680 956" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                ...
                <pattern id="prefix__img1" patternUnits="objectBoundingBox" width="1" height="1" viewBox="0 0 375 812">
                    <image href="https://assets.coinbase.com/assets/portfolio.352f1ebd5622fb93068757ca3a33b88b.svg"
                        width="375" height="812"></image>
                </pattern>
            </defs>
        </svg>
    )
