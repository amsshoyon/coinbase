...
const TrustedCrypto = () => {
    return (
        <section className="trusted-crypto py-lg border-bottom">
            <div className="container sm">
                <div className="Flex-l69ttv-0 Features__Wrapper-o1awuh-0 eWonXt">
                    ...
                    <div className="col-md-4">
                        <div className="d-flex flex-column align-items-center text-center justify-content-between h-100">
                            <div>
                                ...
                                <h2 className="fz20 fw-600 mb-3">Secure storage</h2>
                                <p className="fz16">We store the vast majority of the digital assets in secure offline storage.</p>
                            </div>
                            <a href="https://www.coinbase.com/security" className="text-primary fw-600 d-block mt-5">
                    ...
                    <div className="col-md-4">
                        <div className="d-flex flex-column align-items-center text-center justify-content-between h-100">
                            <div>
                                ...
                                <h2 className="fz20 fw-600 mb-3">Protected by insurance</h2>
                                <p className="fz16">Coinbase maintains crypto insurance and all USD cash balances are covered by FDIC insurance, up to a maximum of $250,000.</p>
                            </div>
                            <a href="https://www.coinbase.com/security" className="text-primary fw-600 d-block mt-5">
                    ...
                    <div className="col-md-4">
                        <div className="d-flex flex-column align-items-center text-center justify-content-between h-100">
                            <div>
                                ...
                                <h2 className="fz20 fw-600 mb-3">Industry best practices</h2>
                                <p className="fz16">Coinbase supports a variety of the most popular digital currencies.</p>
                            </div>
                            <a href="https://www.coinbase.com/security" className="text-primary fw-600 d-block mt-5">
                                Learn how Coinbase keeps your funds safe and secure >
                            </a>
