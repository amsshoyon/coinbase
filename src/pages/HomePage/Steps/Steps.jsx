...
const Steps = () => {
    return (
        <section class="home-steps py-lg">
                    ...
                    <div class="item text-center d-flex flex-column align-items-center mb-5 mb-sm-0">
                        <div className="icon mb-4">
                            <svg width="61" height="56" viewBox="0 0 61 56" fill="none">
                                ...
                                <path d="M28 20c5.523 0 10-4.477 10-10S33.523 0 28 0 18 4.477 18 10s4.477 10 10 10z"
                                    fill="#56B4FC"></path>
                                <path d="M48 36c5.523 0 10-4.477 10-10s-4.477-10-10-10-10 4.477-10 10 4.477 10 10 10z"
                                    fill="#1652F0"></path>
                                <path d="M32 9h-3V6h-2v3h-3v2h3v3h2v-3h3V9zM52 27v-2h-8v2h8z" fill="#fff"></path>
                            </svg>
                        </div>
                        <p class="fz20 fw-600">Start buying &amp; selling</p>
                    </div>
                </div>
            </div>
        </section>
